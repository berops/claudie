...
import (
	...
	tftemplates "github.com/berops/claudie/internal/api/templates/terraform"
...
func TestDownloadProviderUpdate(t *testing.T) {
	...
	if err := tftemplates.DownloadProvider(downloadDir, provider); err != nil {
...
func TestDownloadProvider(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := tftemplates.DownloadProvider(tt.args.downloadInto, tt.args.provider); (err != nil) != tt.wantErr {
