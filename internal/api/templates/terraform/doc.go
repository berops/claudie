// Package terraform provides exported types and necessary helper methods to work with external
// terraform files which can be downloaded from any publicly available git repository.
//
