...
func main() {
	...
	// if status is not SERVING and not NOT_SERVING, return error
	if resp.GetStatus() != healthpb.HealthCheckResponse_SERVING && resp.GetStatus() != healthpb.HealthCheckResponse_NOT_SERVING {
