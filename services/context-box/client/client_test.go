...
func TestDeleteConfig(t *testing.T) {
	c, cc := ClientConnection()
	configID := "629f15b5520cc5f350d39994" //configIDDefault // Put desired config ID here
...
func TestPrintConfig(t *testing.T) {
	c, cc := ClientConnection()
	out, err := PrintConfig(c /*configIDDefault*/, "629e13c02bda23728879e59e", pb.IdType_HASH) // Put desired config ID here
	if err != nil {
