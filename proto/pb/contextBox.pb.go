...
var file_proto_contextBox_proto_rawDesc = []byte{
	...
	0x04, 0x48, 0x41, 0x53, 0x48, 0x10, 0x01, 0x32, 0xe1, 0x05, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x74,
...
var file_proto_contextBox_proto_depIdxs = []int32{
	...
	2,  // 17: claudie.ContextBoxService.SaveConfigFrontEnd:output_type -> claudie.SaveConfigResponse
	2,  // 18: claudie.ContextBoxService.SaveConfigScheduler:output_type -> claudie.SaveConfigResponse
	2,  // 19: claudie.ContextBoxService.SaveConfigBuilder:output_type -> claudie.SaveConfigResponse
	8,  // 20: claudie.ContextBoxService.GetConfigFromDB:output_type -> claudie.GetConfigFromDBResponse
	10, // 21: claudie.ContextBoxService.GetConfigByName:output_type -> claudie.GetConfigByNameResponse
	...
	12, // 25: claudie.ContextBoxService.DeleteConfig:output_type -> claudie.DeleteConfigResponse
