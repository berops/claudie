...
type Retry_Repeat_ struct {
	Repeat *Retry_Repeat `protobuf:"bytes,1,opt,name=repeat,proto3,oneof"`
}

type Retry_Rollback_ struct {
	Rollback *Retry_Rollback `protobuf:"bytes,2,opt,name=rollback,proto3,oneof"`
}
...
type Retry_Repeat struct {
	...
	// cap specifies the maximum allowed timeout, anything above this
	// should be ignored and capped at the specified value. Does not apply
	// for ENDLESS kind.
	// example: cap = 5 would specify that a repeat of a timeout longer than 5 minutes
	// would be set to 5 instead.
	Cap uint32 `protobuf:"varint,2,opt,name=cap,proto3" json:"cap,omitempty"`
	// stopAfter specifies how long should the retry be execute for. Does not
	// apply for ENDLESS kind.
	// example: stopAfter = 5 would specify that after 5 minutes no more retries
	// would be done.
...
func (x *Retry_Repeat) GetCap() uint32 {
	if x != nil {
		return x.Cap
	}
	return 0
...
var file_spec_manifest_proto_rawDesc = []byte{
	...
	0x07, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xb0, 0x02, 0x0a, 0x05, 0x52, 0x65, 0x74,
	0x72, 0x79, 0x12, 0x2c, 0x0a, 0x06, 0x72, 0x65, 0x70, 0x65, 0x61, 0x74, 0x18, 0x01, 0x20, 0x01,
	...
	0x12, 0x32, 0x0a, 0x08, 0x72, 0x6f, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01,
	...
	0x62, 0x61, 0x63, 0x6b, 0x1a, 0x8b, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x70, 0x65, 0x61, 0x74, 0x12,
	...
	0x74, 0x2e, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x10, 0x0a, 0x03,
	0x63, 0x61, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x63, 0x61, 0x70, 0x12, 0x1c,
	0x0a, 0x09, 0x73, 0x74, 0x6f, 0x70, 0x41, 0x66, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x09, 0x73, 0x74, 0x6f, 0x70, 0x41, 0x66, 0x74, 0x65, 0x72, 0x22, 0x24, 0x0a, 0x04,
