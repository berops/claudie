...
var file_spec_manifest_proto_rawDesc = []byte{
	...
	0x6f, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xb8, 0x01, 0x0a, 0x04, 0x52,
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x63, 0x0a, 0x06, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12,
...
var file_spec_manifest_proto_depIdxs = []int32{
	...
	31, // 26: spec.Retry.repeat:type_name -> spec.Retry.Repeat
	32, // 27: spec.Retry.rollback:type_name -> spec.Retry.Rollback
	26, // 28: spec.Task.createState:type_name -> spec.CreateState
	27, // 29: spec.Task.updateState:type_name -> spec.UpdateState
	28, // 30: spec.Task.deleteState:type_name -> spec.DeleteState
	16, // 31: spec.CreateState.k8s:type_name -> spec.K8scluster
	13, // 32: spec.CreateState.lbs:type_name -> spec.LoadBalancers
	16, // 33: spec.UpdateState.k8s:type_name -> spec.K8scluster
