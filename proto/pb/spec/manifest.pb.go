...
var file_spec_manifest_proto_rawDesc = []byte{
	...
	0x6c, 0x73, 0x22, 0xb8, 0x01, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e,
...
var file_spec_manifest_proto_goTypes = []interface{}{
	...
	(*Role)(nil),                  // 16: spec.Role
	(*Events)(nil),                // 17: spec.Events
	(*TaskEvent)(nil),             // 18: spec.TaskEvent
	(*RetryStrategy)(nil),         // 19: spec.RetryStrategy
	...
	(*UpdateState_Endpoint)(nil),  // 26: spec.UpdateState.Endpoint
	nil,                           // 27: spec.DeleteState.NodepoolsEntry
	(*DNS)(nil),                   // 28: spec.DNS
	(*NodePool)(nil),              // 29: spec.NodePool
...
var file_spec_manifest_proto_depIdxs = []int32{
	...
	9,  // 5: spec.ClusterState.desired:type_name -> spec.Clusters
	17, // 6: spec.ClusterState.events:type_name -> spec.Events
	12, // 7: spec.ClusterState.state:type_name -> spec.Workflow
	13, // 8: spec.Clusters.k8s:type_name -> spec.K8scluster
	10, // 9: spec.Clusters.loadBalancers:type_name -> spec.LoadBalancers
	14, // 10: spec.LoadBalancers.clusters:type_name -> spec.LBcluster
	4,  // 11: spec.Workflow.stage:type_name -> spec.Workflow.Stage
	5,  // 12: spec.Workflow.status:type_name -> spec.Workflow.Status
	15, // 13: spec.K8scluster.clusterInfo:type_name -> spec.ClusterInfo
	15, // 14: spec.LBcluster.clusterInfo:type_name -> spec.ClusterInfo
	16, // 15: spec.LBcluster.roles:type_name -> spec.Role
	28, // 16: spec.LBcluster.dns:type_name -> spec.DNS
	29, // 17: spec.ClusterInfo.nodePools:type_name -> spec.NodePool
	0,  // 18: spec.Role.roleType:type_name -> spec.RoleType
	18, // 19: spec.Events.events:type_name -> spec.TaskEvent
	30, // 20: spec.TaskEvent.timestamp:type_name -> google.protobuf.Timestamp
	2,  // 21: spec.TaskEvent.event:type_name -> spec.Event
	20, // 22: spec.TaskEvent.task:type_name -> spec.Task
	19, // 23: spec.TaskEvent.onError:type_name -> spec.RetryStrategy
	18, // 24: spec.RetryStrategy.rollback:type_name -> spec.TaskEvent
	21, // 25: spec.Task.createState:type_name -> spec.CreateState
	22, // 26: spec.Task.updateState:type_name -> spec.UpdateState
	23, // 27: spec.Task.deleteState:type_name -> spec.DeleteState
	13, // 28: spec.CreateState.k8s:type_name -> spec.K8scluster
	10, // 29: spec.CreateState.lbs:type_name -> spec.LoadBalancers
	13, // 30: spec.UpdateState.k8s:type_name -> spec.K8scluster
	10, // 31: spec.UpdateState.lbs:type_name -> spec.LoadBalancers
	26, // 32: spec.UpdateState.endpoint:type_name -> spec.UpdateState.Endpoint
	13, // 33: spec.DeleteState.k8s:type_name -> spec.K8scluster
	10, // 34: spec.DeleteState.lbs:type_name -> spec.LoadBalancers
	27, // 35: spec.DeleteState.nodepools:type_name -> spec.DeleteState.NodepoolsEntry
	8,  // 36: spec.Config.ClustersEntry.value:type_name -> spec.ClusterState
	24, // 37: spec.DeleteState.NodepoolsEntry.value:type_name -> spec.DeletedNodes
