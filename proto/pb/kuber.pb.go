...
var file_proto_kuber_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xe8, 0x05, 0x0a, 0x0c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x63, 0x0a, 0x14, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x4c,
	0x62, 0x53, 0x63, 0x72, 0x61, 0x70, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x24, 0x2e,
	...
	0x6f, 0x72, 0x65, 0x4c, 0x62, 0x53, 0x63, 0x72, 0x61, 0x70, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x12, 0x23, 0x2e, 0x63, 0x6c, 0x61, 0x75, 0x64, 0x69, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x4c, 0x62, 0x53, 0x63, 0x72, 0x61, 0x70, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x63, 0x6c, 0x61, 0x75, 0x64, 0x69, 0x65,
	0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x4c, 0x62, 0x53, 0x63, 0x72, 0x61, 0x70, 0x65, 0x43, 0x6f,
	...
	0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_proto_kuber_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_proto_kuber_proto_goTypes = []interface{}{
	...
	(*K8Scluster)(nil),                    // 16: claudie.K8scluster
	(*LBcluster)(nil),                     // 17: claudie.LBcluster
}
var file_proto_kuber_proto_depIdxs = []int32{
	16, // 0: claudie.SetUpStorageRequest.desiredCluster:type_name -> claudie.K8scluster
	16, // 1: claudie.SetUpStorageResponse.desiredCluster:type_name -> claudie.K8scluster
	16, // 2: claudie.StoreKubeconfigRequest.cluster:type_name -> claudie.K8scluster
	16, // 3: claudie.DeleteKubeconfigRequest.cluster:type_name -> claudie.K8scluster
	16, // 4: claudie.DeleteNodesRequest.cluster:type_name -> claudie.K8scluster
	16, // 5: claudie.DeleteNodesResponse.cluster:type_name -> claudie.K8scluster
	16, // 6: claudie.StoreClusterMetadataRequest.cluster:type_name -> claudie.K8scluster
	16, // 7: claudie.StoreLbScrapeConfigRequest.cluster:type_name -> claudie.K8scluster
	17, // 8: claudie.StoreLbScrapeConfigRequest.desiredLoadbalancers:type_name -> claudie.LBcluster
	16, // 9: claudie.RemoveLbScrapeConfigRequest.cluster:type_name -> claudie.K8scluster
	16, // 10: claudie.DeleteClusterMetadataRequest.cluster:type_name -> claudie.K8scluster
	12, // 11: claudie.KuberService.RemoveLbScrapeConfig:input_type -> claudie.RemoveLbScrapeConfigRequest
	10, // 12: claudie.KuberService.StoreLbScrapeConfig:input_type -> claudie.StoreLbScrapeConfigRequest
	8,  // 13: claudie.KuberService.StoreClusterMetadata:input_type -> claudie.StoreClusterMetadataRequest
	14, // 14: claudie.KuberService.DeleteClusterMetadata:input_type -> claudie.DeleteClusterMetadataRequest
	0,  // 15: claudie.KuberService.SetUpStorage:input_type -> claudie.SetUpStorageRequest
	2,  // 16: claudie.KuberService.StoreKubeconfig:input_type -> claudie.StoreKubeconfigRequest
	4,  // 17: claudie.KuberService.DeleteKubeconfig:input_type -> claudie.DeleteKubeconfigRequest
	6,  // 18: claudie.KuberService.DeleteNodes:input_type -> claudie.DeleteNodesRequest
	13, // 19: claudie.KuberService.RemoveLbScrapeConfig:output_type -> claudie.RemoveLbScrapeConfigResponse
	11, // 20: claudie.KuberService.StoreLbScrapeConfig:output_type -> claudie.StoreLbScrapeConfigResponse
	9,  // 21: claudie.KuberService.StoreClusterMetadata:output_type -> claudie.StoreClusterMetadataResponse
	15, // 22: claudie.KuberService.DeleteClusterMetadata:output_type -> claudie.DeleteClusterMetadataResponse
	1,  // 23: claudie.KuberService.SetUpStorage:output_type -> claudie.SetUpStorageResponse
	3,  // 24: claudie.KuberService.StoreKubeconfig:output_type -> claudie.StoreKubeconfigResponse
	5,  // 25: claudie.KuberService.DeleteKubeconfig:output_type -> claudie.DeleteKubeconfigResponse
	7,  // 26: claudie.KuberService.DeleteNodes:output_type -> claudie.DeleteNodesResponse
