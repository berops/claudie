...
var file_proto_kuber_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0x8a, 0x02, 0x0a, 0x0c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x4b, 0x0a, 0x0c, 0x53, 0x65, 0x74, 0x55, 0x70, 0x53, 0x74, 0x6f, 0x72, 0x61,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a,
...
var file_proto_kuber_proto_goTypes = []interface{}{
	...
	(*K8Scluster)(nil),               // 7: claudie.K8scluster
}
var file_proto_kuber_proto_depIdxs = []int32{
	6, // 0: claudie.SetUpStorageRequest.desiredState:type_name -> claudie.Project
	6, // 1: claudie.SetUpStorageResponse.desiredState:type_name -> claudie.Project
	7, // 2: claudie.StoreKubeconfigRequest.cluster:type_name -> claudie.K8scluster
	7, // 3: claudie.DeleteKubeconfigRequest.cluster:type_name -> claudie.K8scluster
	0, // 4: claudie.KuberService.SetUpStorage:input_type -> claudie.SetUpStorageRequest
	2, // 5: claudie.KuberService.StoreKubeconfig:input_type -> claudie.StoreKubeconfigRequest
	4, // 6: claudie.KuberService.DeleteKubeconfig:input_type -> claudie.DeleteKubeconfigRequest
	1, // 7: claudie.KuberService.SetUpStorage:output_type -> claudie.SetUpStorageResponse
	3, // 8: claudie.KuberService.StoreKubeconfig:output_type -> claudie.StoreKubeconfigResponse
	5, // 9: claudie.KuberService.DeleteKubeconfig:output_type -> claudie.DeleteKubeconfigResponse
