...
var file_proto_kuber_proto_rawDesc = []byte{
	...
	0x0c, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x4c, 0x0a,
	...
	0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x47, 0x0a, 0x16, 0x53,
	...
	0x73, 0x74, 0x65, 0x72, 0x22, 0x19, 0x0a, 0x17, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x4b, 0x75, 0x62,
	...
	0x75, 0x73, 0x74, 0x65, 0x72, 0x22, 0x4c, 0x0a, 0x1b, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6c,
	...
	0x74, 0x65, 0x72, 0x22, 0x1e, 0x0a, 0x1c, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6c, 0x75, 0x73,
	...
	0x74, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x32, 0xa1, 0x04, 0x0a, 0x0c, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x63, 0x0a, 0x14, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6c, 0x75,
...
var file_proto_kuber_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_kuber_proto_goTypes = []interface{}{
	...
	(*Project)(nil),                       // 12: claudie.Project
	(*K8Scluster)(nil),                    // 13: claudie.K8scluster
}
var file_proto_kuber_proto_depIdxs = []int32{
	12, // 0: claudie.SetUpStorageRequest.desiredState:type_name -> claudie.Project
	12, // 1: claudie.SetUpStorageResponse.desiredState:type_name -> claudie.Project
	13, // 2: claudie.StoreKubeconfigRequest.cluster:type_name -> claudie.K8scluster
	13, // 3: claudie.DeleteKubeconfigRequest.cluster:type_name -> claudie.K8scluster
	13, // 4: claudie.DeleteNodesRequest.cluster:type_name -> claudie.K8scluster
	13, // 5: claudie.DeleteNodesResponse.cluster:type_name -> claudie.K8scluster
	13, // 6: claudie.StoreClusterMetadataRequest.cluster:type_name -> claudie.K8scluster
	13, // 7: claudie.DeleteClusterMetadataRequest.cluster:type_name -> claudie.K8scluster
	8,  // 8: claudie.KuberService.StoreClusterMetadata:input_type -> claudie.StoreClusterMetadataRequest
	10, // 9: claudie.KuberService.DeleteClusterMetadata:input_type -> claudie.DeleteClusterMetadataRequest
	0,  // 10: claudie.KuberService.SetUpStorage:input_type -> claudie.SetUpStorageRequest
	2,  // 11: claudie.KuberService.StoreKubeconfig:input_type -> claudie.StoreKubeconfigRequest
	4,  // 12: claudie.KuberService.DeleteKubeconfig:input_type -> claudie.DeleteKubeconfigRequest
	6,  // 13: claudie.KuberService.DeleteNodes:input_type -> claudie.DeleteNodesRequest
	9,  // 14: claudie.KuberService.StoreClusterMetadata:output_type -> claudie.StoreClusterMetadataResponse
	11, // 15: claudie.KuberService.DeleteClusterMetadata:output_type -> claudie.DeleteClusterMetadataResponse
	1,  // 16: claudie.KuberService.SetUpStorage:output_type -> claudie.SetUpStorageResponse
	3,  // 17: claudie.KuberService.StoreKubeconfig:output_type -> claudie.StoreKubeconfigResponse
	5,  // 18: claudie.KuberService.DeleteKubeconfig:output_type -> claudie.DeleteKubeconfigResponse
	7,  // 19: claudie.KuberService.DeleteNodes:output_type -> claudie.DeleteNodesResponse
