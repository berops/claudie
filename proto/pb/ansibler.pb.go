...
var file_ansibler_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x22, 0x9e, 0x01, 0x0a, 0x1d, 0x52, 0x65, 0x6d,
	...
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x4c, 0x62, 0x73, 0x32, 0x82, 0x04, 0x0a, 0x0f, 0x41, 0x6e, 0x73,
...
var file_ansibler_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_ansibler_proto_goTypes = []interface{}{
	...
	(*UpdateAPIEndpointRequest_Endpoint)(nil), // 10: claudie.UpdateAPIEndpointRequest.Endpoint
	(*spec.K8Scluster)(nil),                   // 11: spec.K8scluster
	(*spec.LBcluster)(nil),                    // 12: spec.LBcluster
}
var file_ansibler_proto_depIdxs = []int32{
	11, // 0: claudie.InstallRequest.desired:type_name -> spec.K8scluster
	12, // 1: claudie.InstallRequest.desiredLbs:type_name -> spec.LBcluster
	11, // 2: claudie.InstallResponse.desired:type_name -> spec.K8scluster
	12, // 3: claudie.InstallResponse.desiredLbs:type_name -> spec.LBcluster
	11, // 4: claudie.SetUpLBRequest.desired:type_name -> spec.K8scluster
	12, // 5: claudie.SetUpLBRequest.currentLbs:type_name -> spec.LBcluster
	12, // 6: claudie.SetUpLBRequest.desiredLbs:type_name -> spec.LBcluster
	11, // 7: claudie.SetUpLBResponse.desired:type_name -> spec.K8scluster
	12, // 8: claudie.SetUpLBResponse.currentLbs:type_name -> spec.LBcluster
	12, // 9: claudie.SetUpLBResponse.desiredLbs:type_name -> spec.LBcluster
	11, // 10: claudie.TeardownLBRequest.desired:type_name -> spec.K8scluster
	12, // 11: claudie.TeardownLBRequest.desiredLbs:type_name -> spec.LBcluster
	12, // 12: claudie.TeardownLBRequest.deletedLbs:type_name -> spec.LBcluster
	11, // 13: claudie.TeardownLBResponse.desired:type_name -> spec.K8scluster
	12, // 14: claudie.TeardownLBResponse.desiredLbs:type_name -> spec.LBcluster
	12, // 15: claudie.TeardownLBResponse.deletedLbs:type_name -> spec.LBcluster
	11, // 16: claudie.UpdateAPIEndpointRequest.current:type_name -> spec.K8scluster
	10, // 17: claudie.UpdateAPIEndpointRequest.endpoint:type_name -> claudie.UpdateAPIEndpointRequest.Endpoint
	11, // 18: claudie.UpdateAPIEndpointResponse.current:type_name -> spec.K8scluster
	11, // 19: claudie.RemoveClaudieUtilitiesRequest.current:type_name -> spec.K8scluster
	12, // 20: claudie.RemoveClaudieUtilitiesRequest.currentLbs:type_name -> spec.LBcluster
	11, // 21: claudie.RemoveClaudieUtilitiesResponse.current:type_name -> spec.K8scluster
	12, // 22: claudie.RemoveClaudieUtilitiesResponse.currentLbs:type_name -> spec.LBcluster
	0,  // 23: claudie.AnsiblerService.InstallNodeRequirements:input_type -> claudie.InstallRequest
	0,  // 24: claudie.AnsiblerService.InstallVPN:input_type -> claudie.InstallRequest
	2,  // 25: claudie.AnsiblerService.SetUpLoadbalancers:input_type -> claudie.SetUpLBRequest
	4,  // 26: claudie.AnsiblerService.TeardownLoadBalancers:input_type -> claudie.TeardownLBRequest
	6,  // 27: claudie.AnsiblerService.UpdateAPIEndpoint:input_type -> claudie.UpdateAPIEndpointRequest
	8,  // 28: claudie.AnsiblerService.RemoveClaudieUtilities:input_type -> claudie.RemoveClaudieUtilitiesRequest
	1,  // 29: claudie.AnsiblerService.InstallNodeRequirements:output_type -> claudie.InstallResponse
	1,  // 30: claudie.AnsiblerService.InstallVPN:output_type -> claudie.InstallResponse
	3,  // 31: claudie.AnsiblerService.SetUpLoadbalancers:output_type -> claudie.SetUpLBResponse
	5,  // 32: claudie.AnsiblerService.TeardownLoadBalancers:output_type -> claudie.TeardownLBResponse
	7,  // 33: claudie.AnsiblerService.UpdateAPIEndpoint:output_type -> claudie.UpdateAPIEndpointResponse
	9,  // 34: claudie.AnsiblerService.RemoveClaudieUtilities:output_type -> claudie.RemoveClaudieUtilitiesResponse
