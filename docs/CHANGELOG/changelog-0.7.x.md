...
If you already have clusters deployed, you need to manually upgrade longhorn to version 1.6.0, otherwise claudie will fail during when a workflow is started for a cluster build using older 0.6.x versions.
