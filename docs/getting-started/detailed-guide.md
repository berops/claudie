...
12. Claudie creates kubeconfig secret in claudie namespace:
    ...
    If you want to connect to your kubernetes nodes via SSH, you can recover private SSH key:
    ...
    To recover public IP of a k8s nodes to connect to via SSH:
    ```bash
    ...
    In case you want to connect to your loadbalancer nodes via SSH, you can recover private SSH key:
    ...
    To recover public IP of a LB nodes to connect to via SSH:
